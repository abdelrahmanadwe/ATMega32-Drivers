...
/*------------------------------------------------------------------------------------------------------------------------------------------------------
 *         	                                      This Function initialize the pin which connected to KPD 
 *                                                *------------------------------------------------------------*
 * Parameters : Nothing
 * return     : Nothing  
 */
 ...
 void KPD_voidInit( void )
 {
	...
	/*                  we can use 
		...
		DIO_voidConnectIntPullUp      (KPD_ROW_PORT , KPD_R0 );
		DIO_voidConnectIntPullUp      (KPD_ROW_PORT , KPD_R1 );
		DIO_voidConnectIntPullUp      (KPD_ROW_PORT , KPD_R2 );
		DIO_voidConnectIntPullUp      (KPD_ROW_PORT , KPD_R3 );		
