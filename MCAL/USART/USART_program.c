...
void USART_voidInit (void)
{
	...
	*/
	...
	/*Parity Mode*/
		...
		CLR_BIT(Local_u8UCSRC , UCSRC_UPM0) ; CLR_BIT(Local_u8UCSRC , UCSRC_UPM1) ;
		
	#elif USART_PARITY_MODE == EVEN_PARITY
	
		CLR_BIT(Local_u8UCSRC , UCSRC_UPM0) ; SET_BIT(Local_u8UCSRC , UCSRC_UPM1) ;
		
	#elif USART_PARITY_MODE == ODD_PARITY
	
		SET_BIT(Local_u8UCSRC , UCSRC_UPM0) ; SET_BIT(Local_u8UCSRC , UCSRC_UPM1) ;
 ...
 * return     : Error status with type u8  
 */
u8 USART_u8SendStringSynch (const u8 * Copy_pu8String)
{
	u8 Local_u8ErrorState = OK ;
 ...
 * return     : Error status with type u8  
 */
u8 USART_u8SendStringAsynch(const u8 * Copy_pu8String , void (* NotificationFunc)(void))
{
	u8 Local_u8ErrorState = OK ;
