...
void EXTI_voidSetSignalLatch    ( u8 Copy_u8Line , u8 Copy_u8SenseMode )
{
	...
	if( (Copy_u8Line == EXTI_LINE0) || (Copy_u8Line == EXTI_LINE1) )
	{
		...
		switch ( Copy_u8SenseMode )
		{
			...
			case EXTI_LOW_LEVEL    : CLR_BIT( MCUCR_REG , (Copy_u8Line + 1)); CLR_BIT( MCUCR_REG , Copy_u8Line); break ;
			case EXTI_ON_CHANGE    : CLR_BIT( MCUCR_REG , (Copy_u8Line + 1)); SET_BIT( MCUCR_REG , Copy_u8Line); break ;
			case EXTI_FALLING_EDGE : SET_BIT( MCUCR_REG , (Copy_u8Line + 1)); CLR_BIT( MCUCR_REG , Copy_u8Line); break ;
			case EXTI_RISING_EDGE  : SET_BIT( MCUCR_REG , (Copy_u8Line + 1)); SET_BIT( MCUCR_REG , Copy_u8Line); break ;
