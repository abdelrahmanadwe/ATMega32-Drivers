...
/*------------------------------------------------------------------------------------------------------------------------------------------------------
 *         	                                      A function to tranceive Data between master and slave 
 *                                                *-----------------------------------------------------*
 * Parameters : 
 *		Copy_u8TData => Data to be send
...
/*/*------------------------------------------------------------------------------------------------------------------------------------------------------
 *         	                                      A function to tranceive buffer string between master & slave (polling) 
 *                                                *---------------------------------------------------------------------*
 * Parameters : 
 *      Copy_u8TData       => pointer that holds the data transmit
 *		Copy_u8RData       => pointer that holds the data receive
...
/*/*------------------------------------------------------------------------------------------------------------------------------------------------------
 *         	                                      A function to tranceive buffer string between master & slave (interrupt) 
 *                                                *---------------------------------------------------------------------*
 * Parameters : 
 *      spi_buffer  : pointer to struct SPI_BUFFER
 *            Copy_u8TData      => pointer that holds the data transmit
 *		      Copy_u8RData      => pointer that holds the data receive
 *            Copy_u8BufferSize => size of array
