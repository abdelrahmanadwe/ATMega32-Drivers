...
void ADC_voidInit  ( void )
{
		...
		/*Select the voltage reference*/
			...
			CLR_BIT(ADMUX , ADMUX_REFS1) ; CLR_BIT(ADMUX , ADMUX_REFS0) ;
			
		#elif ADC_VREF == AVCC
		
			CLR_BIT(ADMUX , ADMUX_REFS1) ; SET_BIT(ADMUX , ADMUX_REFS0) ;
			
		#elif ADC_VREF == INTERNAL_2_56
		
			SET_BIT(ADMUX , ADMUX_REFS1) ; SET_BIT(ADMUX , ADMUX_REFS0) ;
